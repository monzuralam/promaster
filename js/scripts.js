(function($) {
    ...
    $('.accordion-header-inner').toggleClass('inactive-header-inner');
    $('.accordion-header-inner').on("click", function() {
        if($(this).is('.inactive-header-inner')) {
            $('.active-header-inner').toggleClass('active-header-inner').toggleClass('inactive-header-inner').next().slideToggle().toggleClass('open-content');
            $(this).toggleClass('active-header-inner').toggleClass('inactive-header-inner');
            $(this).next().slideToggle().toggleClass('open-content');
        }
        else {
            $(this).toggleClass('active-header-inner').toggleClass('inactive-header-inner');
